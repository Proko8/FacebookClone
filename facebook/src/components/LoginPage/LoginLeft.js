    ...
    return (
        <div className="loginleft">
            ...
            <div className="loginleft__text">
                <h3 className="loginleft__boldfont"><img className="longleft__pics1" src="https://www.shareicon.net/data/2017/05/30/886502_photo_512x512.png" alt=""/>See photos and updates from friends in News Feed.</h3>
